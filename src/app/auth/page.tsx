    ...
    if (mode === "signup") {
      ...
      try {
        ...
        if (role === "admin") {
          ...
          window.location.href = "/dashboard/mentor/courses";
        } else {
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          <a
            ...
            className="flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl border border-border bg-card hover:bg-accent/40 text-xs font-semibold text-foreground transition-all shadow-xs hover:border-primary/40 cursor-pointer group"
          >
            ...
            <span className="truncate group-hover:text-primary transition-colors">Google</span>
          </a>

          <button
            type="button"
            disabled
            className="flex flex-col items-center justify-center gap-0.5 py-2 px-3 rounded-xl border border-border bg-muted/40 text-xs font-semibold text-muted-foreground opacity-60 cursor-not-allowed"
          >
            ...
            <span className="text-[8px] text-muted-foreground/80 leading-none">Coming Soon</span>
          </button>
        </div>
      </div>
    </div>
