  ...
  const filteredCourses = useMemo(() => {
    return courses.filter((course) => {
      ...
      const matchesCategory = selectedCategory
        ...
        : true;
      const courseLevel = course.level || LEVEL_MAP[course.category] || "Beginner";
              ...
              {isLoading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {filteredCourses.map((course) => {
                    const level = course.level || LEVEL_MAP[course.category] || "Beginner";
                      ...
                      >
                        ...
                        <div className="border-t border-border/60 pt-4 flex items-center justify-between mt-4">
                          <div>
                            ...
                            {course.duration && <p className="text-[9px] text-muted-foreground">Duration: {course.duration}</p>}
                          </div>
