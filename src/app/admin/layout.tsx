    ...
    <div className="flex-1 flex flex-col md:flex-row bg-background">
      ...
      <header className="md:hidden flex items-center justify-between px-4 h-16 border-b border-border bg-card">
        <Link href="/admin" className="flex items-center gap-1.5">
          <div className="w-7 h-7 rounded-lg bg-linear-to-tr from-red-500 to-orange-500 flex items-center justify-center text-white text-xs font-bold">
            A
          </div>
      ...
      <aside className="hidden md:flex md:w-64 bg-card border-r border-border flex-col justify-between p-6 shrink-0">
        <div className="space-y-8">
          <Link href="/admin" className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-linear-to-tr from-red-500 to-orange-500 flex items-center justify-center text-white font-bold text-sm">
