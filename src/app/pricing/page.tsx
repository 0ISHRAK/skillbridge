  ...
  const plans = [
    {
      name: "Starter Pack",
      price: 500,
      tokens: "50 Skill Tokens",
      description: "Ideal for quick CV reviews, booking a 30-min mentor pass, or claiming your first badge.",
      features: [
        "50 Tokens added to wallet",
        "Book sessions with any mentor",
        "Redeem rewards & course discounts",
        "bKash & Nagad support",
    ...
    },
    {
      ...
      price: 1000,
      tokens: "120 Skill Tokens",
      description: "Our most popular pack for active learners. Includes 20 bonus tokens (20% extra value).",
      features: [
        "120 Tokens added to wallet",
        "20 Bonus Tokens included (৳200 value)",
    ...
    },
    {
      ...
      price: 2500,
      tokens: "320 Skill Tokens",
      description: "Best for ongoing long-term mentorship, career track transitions, or learning 3+ new skills.",
      features: [
        "320 Tokens added to wallet",
        "70 Bonus Tokens included (৳700 value)",
        "Direct mentor Slack channels access",
        "Weekly project code reviews",
